...
M.configure_highlights = function()
	...
	hl(0, "LspSagaAutoPreview", { fg = "#51afef" })
	hl(0, "LspSagaCodeActionBorder", { fg = "#cba6f7" })
	hl(0, "LspSagaCodeActionContent", { bold = true, fg = "#98be65" })
	hl(0, "LspSagaCodeActionTitle", { bold = true, fg = "#da8548" })
	hl(0, "LspSagaDiagnosticBorder", { fg = "#cba6f7" })
	hl(0, "LspSagaDiagnosticHeader", { fg = "#afd700" })
	hl(0, "LspSagaFinderSelection", { bold = true, fg = "#89d957" })
	hl(0, "LspSagaHoverBorder", { fg = "#f7bb3b" })
	hl(0, "LspSagaLspFinderBorder", { fg = "#51afef" })
	hl(0, "LspSagaRenameBorder", { fg = "#3bb6c4" })
	hl(0, "LspSagaSignatureHelpBorder", { fg = "#98be65" })
	...
	hl(0, "TSConstBuiltin", { fg = "#9976a8", italic = true })
	...
	hl(0, "TSFuncBuiltin", { fg = "#CC7832", italic = true })
